...
GO
/****** Object:  StoredProcedure [dbo].[UsersSignup]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[UsersSignup]
GO
/****** Object:  StoredProcedure [dbo].[UsersOtpVerify]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[UsersOtpVerify]
GO
/****** Object:  StoredProcedure [dbo].[UsersLoginGet]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[UsersLoginGet]
GO
/****** Object:  StoredProcedure [dbo].[UsersCompleteProfile]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[UsersCompleteProfile]
GO
/****** Object:  StoredProcedure [dbo].[UserLogin]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[UserLogin]
GO
/****** Object:  StoredProcedure [dbo].[UnitsGet]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[UnitsGet]
GO
/****** Object:  StoredProcedure [dbo].[UnitsEdit]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[UnitsEdit]
GO
/****** Object:  StoredProcedure [dbo].[UnitsDel]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[UnitsDel]
GO
/****** Object:  StoredProcedure [dbo].[UnitsAdd]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[UnitsAdd]
GO
/****** Object:  StoredProcedure [dbo].[OrganizationsGet]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[OrganizationsGet]
GO
/****** Object:  StoredProcedure [dbo].[OrganizationsEdit]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[OrganizationsEdit]
GO
/****** Object:  StoredProcedure [dbo].[OrganizationsDel]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[OrganizationsDel]
GO
/****** Object:  StoredProcedure [dbo].[OrganizationsAdd]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[OrganizationsAdd]
GO
/****** Object:  StoredProcedure [dbo].[BuildingsGet]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[BuildingsGet]
GO
/****** Object:  StoredProcedure [dbo].[BuildingsEdit]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[BuildingsEdit]
GO
/****** Object:  StoredProcedure [dbo].[BuildingsDel]    Script Date: 9/14/2026 5:12:02 PM ******/
DROP PROCEDURE [dbo].[BuildingsDel]
GO
/****** Object:  StoredProcedure [dbo].[BuildingsAdd]    Script Date: 9/14/2026 5:12:02 PM ******/
...
GO
/****** Object:  Index [UQ_Users_Username]    Script Date: 9/14/2026 5:12:02 PM ******/
ALTER TABLE [dbo].[Users] DROP CONSTRAINT [UQ_Users_Username]
GO
/****** Object:  Index [UQ_Users_NationalId]    Script Date: 9/14/2026 5:12:02 PM ******/
ALTER TABLE [dbo].[Users] DROP CONSTRAINT [UQ_Users_NationalId]
GO
/****** Object:  Index [UQ_Users_Email]    Script Date: 9/14/2026 5:12:02 PM ******/
ALTER TABLE [dbo].[Users] DROP CONSTRAINT [UQ_Users_Email]
GO
/****** Object:  Index [UQ_UserRoles_User_Role]    Script Date: 9/14/2026 5:12:02 PM ******/
ALTER TABLE [dbo].[UserRoles] DROP CONSTRAINT [UQ_UserRoles_User_Role]
GO
/****** Object:  Index [UQ_UserProfiles_UserId]    Script Date: 9/14/2026 5:12:02 PM ******/
ALTER TABLE [dbo].[UserProfiles] DROP CONSTRAINT [UQ_UserProfiles_UserId]
GO
/****** Object:  Index [UQ_UserOtpRateLimits_Mobile]    Script Date: 9/14/2026 5:12:02 PM ******/
ALTER TABLE [dbo].[UserOtpRateLimits] DROP CONSTRAINT [UQ_UserOtpRateLimits_Mobile]
GO
/****** Object:  Index [UQ_RoleMenus_Role_Menu]    Script Date: 9/14/2026 5:12:02 PM ******/
ALTER TABLE [dbo].[RoleMenus] DROP CONSTRAINT [UQ_RoleMenus_Role_Menu]
GO
/****** Object:  Table [dbo].[Users]    Script Date: 9/14/2026 5:12:02 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Users]') AND type in (N'U'))
DROP TABLE [dbo].[Users]
GO
/****** Object:  Table [dbo].[UserRoles]    Script Date: 9/14/2026 5:12:02 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UserRoles]') AND type in (N'U'))
DROP TABLE [dbo].[UserRoles]
GO
/****** Object:  Table [dbo].[UserResidencies]    Script Date: 9/14/2026 5:12:02 PM ******/
...
GO
/****** Object:  Table [dbo].[UserProfiles]    Script Date: 9/14/2026 5:12:02 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UserProfiles]') AND type in (N'U'))
DROP TABLE [dbo].[UserProfiles]
GO
/****** Object:  Table [dbo].[UserOtpRequests]    Script Date: 9/14/2026 5:12:02 PM ******/
...
GO
/****** Object:  Table [dbo].[UserOtpRateLimits]    Script Date: 9/14/2026 5:12:02 PM ******/
...
GO
/****** Object:  Table [dbo].[Employees]    Script Date: 9/14/2026 5:12:02 PM ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Employees]') AND type in (N'U'))
DROP TABLE [dbo].[Employees]
GO
/****** Object:  Table [dbo].[EmployeeAssignments]    Script Date: 9/14/2026 5:12:02 PM ******/
...
GO
/****** Object:  Table [dbo].[Buildings]    Script Date: 9/14/2026 5:12:02 PM ******/
...
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (1, NULL, N'داشبورد', N'/dashboard', N'dashboard', 1, N'صفحه اصلی سامانه', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.383' AS DateTime), NULL, NULL, NULL, N'داشبورد', NULL, N'صفحه اصلی سامانه', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (2, NULL, N'مدیریت کاربران', N'/users', N'users', 2, N'مدیریت مالکین، ساکنین، مهمانان و اعضای خارجی', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.387' AS DateTime), NULL, NULL, NULL, N'مدیریت کاربران', NULL, N'مدیریت مالکین، ساکنین، مهمانان و اعضای خارجی', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (3, NULL, N'مدیریت نقش‌ها', N'/roles', N'roles', 3, N'مدیریت نقش‌های سامانه', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.390' AS DateTime), NULL, NULL, NULL, N'مدیریت نقش‌ها', NULL, N'مدیریت نقش‌های سامانه', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (4, NULL, N'مدیریت دسترسی‌ها', N'/permissions', N'lock', 4, N'مدیریت دسترسی نقش‌ها به منوهای سامانه', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.390' AS DateTime), NULL, NULL, NULL, N'مدیریت دسترسی‌ها', NULL, N'مدیریت دسترسی نقش‌ها به منوهای سامانه', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (5, NULL, N'ساختمان', N'/building', N'building', 5, N'مدیریت ساختمان برج', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.393' AS DateTime), NULL, NULL, NULL, N'ساختمان', NULL, N'مدیریت ساختمان برج', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (6, NULL, N'واحدها', N'/units', N'home', 6, N'مدیریت واحدهای ساختمان', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.397' AS DateTime), NULL, NULL, NULL, N'واحدها', NULL, N'مدیریت واحدهای ساختمان', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (7, NULL, N'باشگاه ورزشی', N'/club', N'fitness_center', 7, N'مدیریت باشگاه ورزشی برج', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.397' AS DateTime), NULL, NULL, NULL, N'باشگاه ورزشی', NULL, N'مدیریت باشگاه ورزشی برج', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (8, NULL, N'رزروها', N'/reservations', N'calendar', 8, N'مدیریت رزروهای باشگاه', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.400' AS DateTime), NULL, NULL, NULL, N'رزروها', NULL, N'مدیریت رزروهای باشگاه', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (9, NULL, N'شارژ ساختمان', N'/charges', N'account_balance_wallet', 9, N'مدیریت شارژ واحدها', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.400' AS DateTime), NULL, NULL, NULL, N'شارژ ساختمان', NULL, N'مدیریت شارژ واحدها', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (10, NULL, N'پرداخت‌ها', N'/payments', N'payment', 10, N'مدیریت پرداخت‌ها و تراکنش‌های مالی', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.403' AS DateTime), NULL, NULL, NULL, N'پرداخت‌ها', NULL, N'مدیریت پرداخت‌ها و تراکنش‌های مالی', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (11, NULL, N'گزارش‌ها', N'/reports', N'report', 11, N'گزارش‌های مدیریتی و مالی', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.403' AS DateTime), NULL, NULL, NULL, N'گزارش‌ها', NULL, N'گزارش‌های مدیریتی و مالی', NULL)
GO
INSERT [dbo].[Menus] ([MenuId], [ParentId], [Title], [MenuUrl], [Icon], [SortOrder], [MenuDescription], [IsVisible], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater], [TitleFa], [TitleEn], [MenuDescriptionFa], [MenuDescriptionEn]) VALUES (12, NULL, N'تنظیمات', N'/settings', N'settings', 12, N'تنظیمات عمومی سامانه', 1, 1, NULL, CAST(N'2026-09-01T17:22:05.407' AS DateTime), NULL, NULL, NULL, N'تنظیمات', NULL, N'تنظیمات عمومی سامانه', NULL)
GO
...
GO
INSERT [dbo].[Roles] ([RoleId], [RoleName], [RoleDescription], [RoleCode], [RoleNameFa], [RoleNameEn], [RoleDescriptionFa], [RoleDescriptionEn]) VALUES (1, N'مدیر سیستم', N'دسترسی کامل به تمام بخش‌های سامانه', NULL, N'مدیر سیستم', NULL, N'دسترسی کامل به تمام بخش‌های سامانه', NULL)
GO
INSERT [dbo].[Roles] ([RoleId], [RoleName], [RoleDescription], [RoleCode], [RoleNameFa], [RoleNameEn], [RoleDescriptionFa], [RoleDescriptionEn]) VALUES (2, N'مدیر باشگاه', N'مدیریت کامل باشگاه ورزشی، اعضا، سانس‌ها و رزروها', NULL, N'مدیر باشگاه', NULL, N'مدیریت کامل باشگاه ورزشی، اعضا، سانس‌ها و رزروها', NULL)
GO
INSERT [dbo].[Roles] ([RoleId], [RoleName], [RoleDescription], [RoleCode], [RoleNameFa], [RoleNameEn], [RoleDescriptionFa], [RoleDescriptionEn]) VALUES (3, N'پذیرش باشگاه', N'مدیریت پذیرش، مشاهده اعضا و ثبت رزرو', NULL, N'پذیرش باشگاه', NULL, N'مدیریت پذیرش، مشاهده اعضا و ثبت رزرو', NULL)
GO
INSERT [dbo].[Roles] ([RoleId], [RoleName], [RoleDescription], [RoleCode], [RoleNameFa], [RoleNameEn], [RoleDescriptionFa], [RoleDescriptionEn]) VALUES (4, N'مدیر ساختمان', N'مدیریت واحدها، مالکین و ساکنین برج', NULL, N'مدیر ساختمان', NULL, N'مدیریت واحدها، مالکین و ساکنین برج', NULL)
GO
INSERT [dbo].[Roles] ([RoleId], [RoleName], [RoleDescription], [RoleCode], [RoleNameFa], [RoleNameEn], [RoleDescriptionFa], [RoleDescriptionEn]) VALUES (5, N'حسابدار', N'مدیریت شارژ، پرداخت‌ها و گزارش‌های مالی', NULL, N'حسابدار', NULL, N'مدیریت شارژ، پرداخت‌ها و گزارش‌های مالی', NULL)
GO
INSERT [dbo].[Roles] ([RoleId], [RoleName], [RoleDescription], [RoleCode], [RoleNameFa], [RoleNameEn], [RoleDescriptionFa], [RoleDescriptionEn]) VALUES (6, N'ساکن', N'دسترسی عمومی ساکنین به خدمات ساختمان و باشگاه', NULL, N'ساکن', NULL, N'دسترسی عمومی ساکنین به خدمات ساختمان و باشگاه', NULL)
GO
INSERT [dbo].[Roles] ([RoleId], [RoleName], [RoleDescription], [RoleCode], [RoleNameFa], [RoleNameEn], [RoleDescriptionFa], [RoleDescriptionEn]) VALUES (7, N'عضو خارجی باشگاه', N'کاربر خارج از برج که عضو باشگاه ورزشی است', NULL, N'عضو خارجی باشگاه', NULL, N'کاربر خارج از برج که عضو باشگاه ورزشی است', NULL)
GO
...
GO
INSERT [dbo].[Users] ([UserId], [Username], [PasswordHash], [Email], [Mobile], [FirstName], [LastName], [NationalId], [Gender], [BirthDate], [AvatarUrl], [PhoneVerified], [LastLoginAt], [IsActive], [IsDeleted], [CreatedAt], [UserCreater], [UpdatedAt], [UserUpdater]) VALUES (1, N'admin', N'1234', N'admin@boosatan.ir', N'09120000001', N'مدیر', N'سیستم', N'0012345678', 1, CAST(N'1985-01-15T00:00:00.000' AS DateTime), NULL, 1, CAST(N'2026-09-14T17:08:33.000' AS DateTime), 1, NULL, CAST(N'2026-09-01T17:22:05.450' AS DateTime), NULL, NULL, NULL)
GO
